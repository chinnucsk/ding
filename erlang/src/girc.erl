...
handle_numeric_reply(001, _Msg) -> 
    io:format("Reply for RPL_WELCOME not implemented.~n"),
    ok;
%% RPL_
...
handle_numeric_reply(005, _Msg) ->
    io:format("Reply for RPL_BOUNCE not implemented.~n"),
    ok;
...
handle_numeric_reply(302, _Msg) ->
    io:format("Reply for RPL_USERHOST not implemented.~n"),
    ok;
...
handle_numeric_reply(303, _Msg) ->
    io:format("Reply for RPL_ISON not implemented.~n"),
    ok;
...
handle_numeric_reply(301, _Msg) ->
    io:format("Reply for RPL_AWAY not implemented.~n"),
    ok;

%% RPL_UNAWAY
handle_numeric_reply(305, _Msg) ->
    io:format("Reply for RPL_UNAWAY no implemented yet.~n"),
    ok;

%% RPL_NOWAWAY
handle_numeric_reply(306, _Msg) ->
    io:format("Reply for RPL_NOWAWAY no implemented yet.~n"),
    ok;
...
handle_numeric_reply(311, _Msg) ->
    io:format("Reply for RPL_WHOISUSER no implemented yet.~n"),
    ok;
%% RPL_WHOISSERVER
handle_numeric_reply(312, _Msg) ->
    io:format("Reply for RPL_WHOISSERVER no implemented yet.~n"),
    ok;
%% RPL_WHOISOPERATOR
handle_numeric_reply(313, _Msg) ->
    io:format("Reply for RPL_WHOISOPERATOR no implemented yet.~n"),
    ok;
%% RPL_WHOISIDLE
handle_numeric_reply(317, _Msg) ->
    io:format("Reply for RPL_WHOISIDLE no implemented yet.~n"),
    ok;
%% RPL_ENDOFWHOIS
handle_numeric_reply(318, _Msg) ->
    io:format("Reply for RPL_ENDOFWHOIS no implemented yet.~n"),
    ok;
%% RPL_WHOISCHANNELS
handle_numeric_reply(319, _Msg) ->
    io:format("Reply for RPL_WHOISCHANNELS no implemented yet.~n"),
    ok;
...
handle_numeric_reply(314, _Msg) ->
    io:format("Reply for RPL_WHOWASUSER no implemented yet.~n"),
    ok;
%% RPL_ENDOFWHOWAS
handle_numeric_reply(369, _Msg) ->
    io:format("Reply for RPL_ENDOFWHOWAS no implemented yet.~n"),
    ok;
...
handle_numeric_reply(322, _Msg) ->
    io:format("Reply for RPL_LIST no implemented yet.~n"),
    ok;
%% RPL_LISTEND
handle_numeric_reply(323, _Msg) ->
    io:format("Reply for RPL_LISTEND no implemented yet.~n"),
    ok;
%% RPL_UNIQOPIS
handle_numeric_reply(325, _Msg) ->
    io:format("Reply for RPL_UNIQOPIS no implemented yet.~n"),
    ok;
%% RPL_CHANNELMODEIS
handle_numeric_reply(324, _Msg) ->
    io:format("Reply for RPL_CHANNELMODEIS no implemented yet.~n"),
    ok;
...
handle_numeric_reply(331, _Msg) ->
    io:format("Reply for RPL_NOTOPIC no implemented yet.~n"),
    ok;
%% RPL_TOPIC
handle_numeric_reply(332, _Msg) ->
    io:format("Reply for RPL_TOPIC no implemented yet.~n"),
    ok;
...
handle_numeric_reply(341, _Msg) ->
    io:format("Reply for RPL_INVITING no implemented yet.~n"),
    ok;
...
handle_numeric_reply(342, _Msg) ->
    io:format("Reply for RPL_SUMMONING no implemented yet.~n"),
    ok;
...
handle_numeric_reply(346, _Msg) ->
    io:format("Reply for RPL_INVITELIST no implemented yet.~n"),
    ok;
%% RPL_ENDOFINVITELIST
handle_numeric_reply(347, _Msg) ->
    io:format("Reply for RPL_ENDOFINVITELIST no implemented yet.~n"),
    ok;
...
handle_numeric_reply(348, _Msg) ->
    io:format("Reply for RPL_EXCEPTLIST no implemented yet.~n"),
    ok;
%% RPL_ENDOFEXCEPTLIST
handle_numeric_reply(349, _Msg) ->
    io:format("Reply for RPL_ENDOFEXCEPTLIST no implemented yet.~n"),
    ok;
...
handle_numeric_reply(351, _Msg) ->
    io:format("Reply for RPL_VERSION no implemented yet.~n"),
    ok;
...
handle_numeric_reply(352, _Msg) ->
    io:format("Reply for RPL_WHOREPLY no implemented yet.~n"),
    ok;
%% RPL_ENDOFWHO
handle_numeric_reply(315, _Msg) ->
    io:format("Reply for RPL_ENDOFWHO no implemented yet.~n"),
    ok;
...
handle_numeric_reply(353, _Msg) ->
    io:format("Reply for RPL_NAMREPLY no implemented yet.~n"),
    ok;
%% RPL_ENDOFNAMES
handle_numeric_reply(366, _Msg) ->
    io:format("Reply for RPL_ENDOFNAMES no implemented yet.~n"),
    ok;
...
handle_numeric_reply(364, _Msg) ->
    io:format("Reply for RPL_LINKS no implemented yet.~n"),
    ok;
%% RPL_ENDOFLINKS
handle_numeric_reply(365, _Msg) ->
    io:format("Reply for RPL_ENDOFLINKS no implemented yet.~n"),
    ok;
...
handle_numeric_reply(367, _Msg) ->
    io:format("Reply for RPL_BANLIST no implemented yet.~n"),
    ok;
%% RPL_ENDOFBANLIST
handle_numeric_reply(368, _Msg) ->
    io:format("Reply for RPL_ENDOFBANLIST no implemented yet.~n"),
    ok;
...
handle_numeric_reply(371, _Msg) ->
    io:format("Reply for RPL_INFO no implemented yet.~n"),
    ok;
%% RPL_ENDOFINFO
handle_numeric_reply(374, _Msg) ->
    io:format("Reply for RPL_ENDOFINFO no implemented yet.~n"),
    ok;
...
handle_numeric_reply(375, _Msg) ->
    io:format("Reply for RPL_MOTDSTART no implemented yet.~n"),
    ok;
%% RPL_MOTD
handle_numeric_reply(372, _Msg) ->
    io:format("Reply for RPL_MOTD no implemented yet.~n"),
    ok;
%% RPL_ENDOFMOTD
...
handle_numeric_reply(381, _Msg) ->
    io:format("Reply for RPL_YOUREOPER no implemented yet.~n"),
    ok;
...
handle_numeric_reply(382, _Msg) ->
    io:format("Reply for RPL_REHASHING no implemented yet.~n"),
    ok;
...
handle_numeric_reply(383, _Msg) ->
    io:format("Reply for RPL_YOURESERVICE no implemented yet.~n"),
    ok;
...
handle_numeric_reply(391, _Msg) ->
    io:format("Reply for RPL_TIME no implemented yet.~n"),
    ok;
...
handle_numeric_reply(392, _Msg) ->
    io:format("Reply for RPL_USERSSTART no implemented yet.~n"),
    ok;
%% RPL_USERS
handle_numeric_reply(393, _Msg) ->
    io:format("Reply for RPL_USERS no implemented yet.~n"),
    ok;
%% RPL_ENDOFUSERS
handle_numeric_reply(394, _Msg) ->
    io:format("Reply for RPL_ENDOFUSERS no implemented yet.~n"),
    ok;
%% RPL_NOUSERS
handle_numeric_reply(395, _Msg) ->
    io:format("Reply for RPL_NOUSERS no implemented yet.~n"),
    ok;
...
handle_numeric_reply(200, _Msg) -> 
    io:format("Reply for RPL_TRACELINK no implemented yet.~n"),
    ok;
%% RPL_TRACECONNECTING
handle_numeric_reply(201, _Msg) -> 
    io:format("Reply for RPL_TRACECONNECTING no implemented yet.~n"),
    ok;

%% RPL_TRACEHANDSHAKE
handle_numeric_reply(202, _Msg) -> 
    io:format("Reply for RPL_TRACEHANDSHAKE no implemented yet.~n"),
    ok;

%% RPL_TRACEUNKNOWN
handle_numeric_reply(203, _Msg) -> 
    io:format("Reply for RPL_TRACEUNKNOWN no implemented yet.~n"),
    ok;

%% RPL_TRACEOPERATOR
handle_numeric_reply(204, _Msg) -> 
    io:format("Reply for RPL_TRACEOPERATOR no implemented yet.~n"),
    ok;

%% RPL_TRACEUSER
handle_numeric_reply(205, _Msg) -> 
    io:format("Reply for RPL_TRACEUSER no implemented yet.~n"),
    ok;

%% RPL_TRACESERVER
handle_numeric_reply(206, _Msg) -> 
    io:format("Reply for RPL_TRACESERVER no implemented yet.~n"),
    ok;

%% RPL_TRACESERVICE
handle_numeric_reply(207, _Msg) -> 
    io:format("Reply for RPL_TRACESERVICE no implemented yet.~n"),
    ok;

%% RPL_TRACENEWTYPE
handle_numeric_reply(208, _Msg) -> 
    io:format("Reply for RPL_TRACENEWTYPE no implemented yet.~n"),
    ok;

%% RPL_TRACECLASS
handle_numeric_reply(209, _Msg) -> 
    io:format("Reply for RPL_TRACECLASS no implemented yet.~n"),
    ok;

%% RPL_TRACERECONNECT
handle_numeric_reply(210, _Msg) -> 
    io:format("Reply for RPL_TRACERECONNECT no implemented yet.~n"),
    ok;

%% RPL_TRACELOG
handle_numeric_reply(261, _Msg) -> 
    io:format("Reply for RPL_TRACELOG no implemented yet.~n"),
    ok;

%% RPL_TRACEEND
handle_numeric_reply(262, _Msg) -> 
    io:format("Reply for RPL_TRACEEND no implemented yet.~n"),
    ok;
...
handle_numeric_reply(211, _Msg) ->
    io:format("Reply for RPL_STATSLINKINFO no implemented yet.~n"),
    ok;
...
handle_numeric_reply(212, _Msg) ->
    io:format("Reply for RPL_STATSCOMMANDS no implemented yet.~n"),
    ok;

%% RPL_ENDOFSTATS
%% "<stats letter> :End of STATS report"
handle_numeric_reply(219, _Msg) ->
    io:format("Reply for RPL_ENDOFSTATS no implemented yet.~n"),
    ok;
...
handle_numeric_reply(242, _Msg) ->
    io:format("Reply for RPL_STATSUPTIME no implemented yet.~n"),
    ok;
...
handle_numeric_reply(243, _Msg) ->
    io:format("Reply for RPL_STATSOLINE no implemented yet.~n"),
    ok;
...
handle_numeric_reply(221, _Msg) ->
    io:format("Reply for RPL_UMODEIS no implemented yet.~n"),
    ok;

%% RPL_SERVLIST
%% "<name> <server> <mask> <type> <hopcount> <info>"
handle_numeric_reply(234, _Msg) ->
    io:format("Reply for RPL_SERVLIST no implemented yet.~n"),
    ok;
...
handle_numeric_reply(235, _Msg) ->
    io:format("Reply for RPL_SERVLISTEND no implemented yet.~n"),
    ok;
...
handle_numeric_reply(251, _Msg) ->
    io:format("Reply for RPL_LUSERCLIENT no implemented yet.~n"),
    ok;

%% RPL_LUSEROP
%% "<integer> :operator(s) online"
handle_numeric_reply(252, _Msg) ->
    io:format("Reply for RPL_LUSEROP no implemented yet.~n"),
    ok;
...
handle_numeric_reply(254, _Msg) ->
    io:format("Reply for RPL_LUSERCHANNELS no implemented yet.~n"),
    ok;

%% RPL_LUSERME
%% ":I have <integer> clients and <integer> servers"
handle_numeric_reply(255, _Msg) ->
    io:format("Reply for RPL_LUSERME no implemented yet.~n"),
    ok;
...
handle_numeric_reply(256, _Msg) ->
    io:format("Reply for RPL_ADMINME no implemented yet.~n"),
    ok;

%% RPL_ADMINLOC1
%% ":<admin info>"
handle_numeric_reply(257, _Msg) ->
    io:format("Reply for RPL_ADMINLOC1 no implemented yet.~n"),
    ok;

%% RPL_ADMINLOC2
%% ":<admin info>"
handle_numeric_reply(258, _Msg) ->
    io:format("Reply for RPL_ADMINLOC2 no implemented yet.~n"),
    ok;
%% RPL_ADMINEMAIL
%% ":<admin info>
handle_numeric_reply(259, _Msg) ->
    io:format("Reply for RPL_ADMINEMAIL no implemented yet.~n"),
    ok;
...
handle_numeric_reply(263, _Msg) ->
    io:format("Reply for RPL_TRYAGAIN no implemented yet.~n"),
    ok;
...
handle_numeric_reply(401, _Msg) ->
    io:format("Reply for ERR_NOSUCHNICK no implemented yet.~n"),
    ok;
...
handle_numeric_reply(402, _Msg) ->
    io:format("Reply for ERR_NOSUCHSERVER no implemented yet.~n"),
    ok;
...
handle_numeric_reply(403, _Msg) ->
    io:format("Reply for ERR_NOSUCHCHANNEL no implemented yet.~n"),
    ok;
...
handle_numeric_reply(404, _Msg) ->
    io:format("Reply for ERR_CANNOTSENDTOCHAN no implemented yet.~n"),
    ok;
...
handle_numeric_reply(405, _Msg) ->
    io:format("Reply for ERR_TOOMANYCHANNELS no implemented yet.~n"),
    ok;
...
handle_numeric_reply(406, _Msg) ->
    io:format("Reply for ERR_WASNOSUCHNICK no implemented yet.~n"),
    ok;
...
handle_numeric_reply(407, _Msg) ->
    io:format("Reply for ERR_TOOMANYTARGETS no implemented yet.~n"),
    ok;
...
handle_numeric_reply(408, _Msg) ->
    io:format("Reply for ERR_NOSUCHSERVICE no implemented yet.~n"),
    ok;
...
handle_numeric_reply(409, _Msg) ->
    io:format("Reply for ERR_NOORIGIN no implemented yet.~n"),
    ok;

%% ERR_NORECIPIENT
%% ":No recipient given (<command>)"
handle_numeric_reply(411, _Msg) ->
    io:format("Reply for ERR_NORECIPIENT no implemented yet.~n"),
    ok;
...
handle_numeric_reply(412, _Msg) ->
    io:format("Reply for ERR_NOTEXTTOSEND no implemented yet.~n"),
    ok;

%% ERR_NOTOPLEVEL
%% "<mask> :No toplevel domain specified"
handle_numeric_reply(413, _Msg) ->
    io:format("Reply for ERR_NOTOPLEVEL no implemented yet.~n"),
    ok;

%% ERR_WILDTOPLEVEL
%% "<mask> :Wildcard in toplevel domain"
handle_numeric_reply(414, _Msg) ->
    io:format("Reply for ERR_WILDTOPLEVEL no implemented yet.~n"),
    ok;

%% ERR_BADMASK
%% "<mask> :Bad Server/host mask"
handle_numeric_reply(415, _Msg) ->
    io:format("Reply for ERR_BADMASK no implemented yet.~n"),
    ok;

%% ERR_UNKNOWNCOMMAND
%% "<command> :Unknown command"
handle_numeric_reply(421, _Msg) ->
    io:format("Reply for ERR_UNKNOWNCOMMAND no implemented yet.~n"),
    ok;

%% ERR_NOMOTD
%% ":MOTD File is missing"
handle_numeric_reply(422, _Msg) ->
    io:format("Reply for ERR_NOMOTD no implemented yet.~n"),
    ok;
...
handle_numeric_reply(423, _Msg) ->
    io:format("Reply for ERR_NOADMININFO no implemented yet.~n"),
    ok;
...
handle_numeric_reply(424, _Msg) ->
    io:format("Reply for ERR_FILEERROR no implemented yet.~n"),
    ok;
...
handle_numeric_reply(431, _Msg) ->
    io:format("Reply for ERR_NONICKNAMEGIVEN no implemented yet.~n"),
    ok;
...
handle_numeric_reply(432, _Msg) ->
    io:format("Reply for ERR_ERRONEUSNICKNAME no implemented yet.~n"),
    ok;
...
handle_numeric_reply(433, _Msg) ->
    io:format("Reply for ERR_NICKNAMEINUSE no implemented yet.~n"),
    ok;
...
handle_numeric_reply(436, _Msg) ->
    io:format("Reply for ERR_NICKCOLLISION no implemented yet.~n"),
    ok;
...
handle_numeric_reply(437, _Msg) ->
    io:format("Reply for ERR_UNAVAILRESOURCE no implemented yet.~n"),
    ok;
...
handle_numeric_reply(441, _Msg) ->
    io:format("Reply for ERR_USERNOTINCHANNEL no implemented yet.~n"),
    ok;
...
handle_numeric_reply(442, _Msg) ->
    io:format("Reply for ERR_NOTONCHANNEL no implemented yet.~n"),
    ok;
...
handle_numeric_reply(443, _Msg) ->
    io:format("Reply for ERR_USERONCHANNEL no implemented yet.~n"),
    ok;
...
handle_numeric_reply(444, _Msg) ->
    io:format("Reply for ERR_NOLOGIN no implemented yet.~n"),
    ok;
...
handle_numeric_reply(445, _Msg) ->
    io:format("Reply for ERR_SUMMONDISABLED no implemented yet.~n"),
    ok;
...
handle_numeric_reply(446, _Msg) ->
    io:format("Reply for ERR_USERSDISABLED no implemented yet.~n"),
    ok;
...
handle_numeric_reply(451, _Msg) ->
    io:format("Reply for ERR_NOTREGISTERED no implemented yet.~n"),
    ok;
...
handle_numeric_reply(461, _Msg) ->
    io:format("Reply for ERR_NEEDMOREPARAMS no implemented yet.~n"),
    ok;
...
handle_numeric_reply(462, _Msg) ->
    io:format("Reply for ERR_ALREADYREGISTRED no implemented yet.~n"),
    ok;
...
handle_numeric_reply(463, _Msg) ->
    io:format("Reply for ERR_NOPERMFORHOST no implemented yet.~n"),
    ok;
...
handle_numeric_reply(464, _Msg) ->
    io:format("Reply for ERR_PASSWDMISMATCH no implemented yet.~n"),
    ok;
...
handle_numeric_reply(465, _Msg) ->
    io:format("Reply for ERR_YOUREBANNEDCREEP no implemented yet.~n"),
    ok;
...
handle_numeric_reply(466, _Msg) ->
    io:format("Reply for ERR_YOUWILLBEBANNED no implemented yet.~n"),
    ok;

%% ERR_KEYSET
%% "<channel> :Channel key already set"
handle_numeric_reply(467, _Msg) ->
    io:format("Reply for ERR_KEYSET no implemented yet.~n"),
    ok;

%% ERR_CHANNELISFULL
%% "<channel> :Cannot join channel (+l)"
handle_numeric_reply(471, _Msg) ->
    io:format("Reply for ERR_CHANNELISFULL no implemented yet.~n"),
    ok;

%% ERR_UNKNOWNMODE
%% "<char> :is unknown mode char to me for <channel>"
handle_numeric_reply(472, _Msg) ->
    io:format("Reply for ERR_UNKNOWNMODE no implemented yet.~n"),
    ok;

%% ERR_INVITEONLYCHAN
%% "<channel> :Cannot join channel (+i)"
handle_numeric_reply(473, _Msg) ->
    io:format("Reply for ERR_INVITEONLYCHAN no implemented yet.~n"),
    ok;

%% ERR_BANNEDFROMCHAN
%% "<channel> :Cannot join channel (+b)"
handle_numeric_reply(474, _Msg) ->
    io:format("Reply for ERR_BANNEDFROMCHAN no implemented yet.~n"),
    ok;

%% ERR_BADCHANNELKEY
%% "<channel> :Cannot join channel (+k)"
handle_numeric_reply(475, _Msg) ->
    io:format("Reply for ERR_BADCHANNELKEY no implemented yet.~n"),
    ok;

%% ERR_BADCHANMASK
%% "<channel> :Bad Channel Mask"
handle_numeric_reply(476, _Msg) ->
    io:format("Reply for ERR_BADCHANMASK no implemented yet.~n"),
    ok;

%% ERR_NOCHANMODES
%% "<channel> :Channel doesn't support modes"
handle_numeric_reply(477, _Msg) ->
    io:format("Reply for ERR_NOCHANMODES no implemented yet.~n"),
    ok;

%% ERR_BANLISTFULL
%% "<channel> <char> :Channel list is full"
handle_numeric_reply(478, _Msg) ->
    io:format("Reply for ERR_BANLISTFULL no implemented yet.~n"),
    ok;
...
handle_numeric_reply(481, _Msg) ->
    io:format("Reply for ERR_NOPRIVILEGES no implemented yet.~n"),
    ok;
...
handle_numeric_reply(482, _Msg) ->
    io:format("Reply for ERR_CHANOPRIVSNEEDED no implemented yet.~n"),
    ok;
...
handle_numeric_reply(483, _Msg) ->
    io:format("Reply for ERR_CANTKILLSERVER no implemented yet.~n"),
    ok;
...
handle_numeric_reply(484, _Msg) ->
    io:format("Reply for ERR_RESTRICTED no implemented yet.~n"),
    ok;
...
handle_numeric_reply(485, _Msg) ->
    io:format("Reply for ERR_UNIQOPPRIVSNEEDED no implemented yet.~n"),
    ok;
...
handle_numeric_reply(491, _Msg) ->
    io:format("Reply for ERR_NOOPERHOST no implemented yet.~n"),
    ok;
...
handle_numeric_reply(501, _Msg) ->
    io:format("Reply for ERR_UMODEUNKNOWNFLAG no implemented yet.~n"),
    ok;
...
handle_numeric_reply(502, _Msg) ->
    io:format("Reply for ERR_USERSDONTMATCH no implemented yet.~n"),
    ok;
